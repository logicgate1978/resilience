...
install_kubectl() {
  ...
  curl -fsSL "https://dl.k8s.io/release/${stable_version}/bin/linux/${KUBECTL_ARCH}/kubectl" -o "${TMP_DIR}/kubectl"
...
install_eksctl() {
  ...
  curl -fsSL "https://github.com/eksctl-io/eksctl/releases/latest/download/eksctl_${EKSCTL_PLATFORM}.tar.gz" -o "${TMP_DIR}/eksctl.tar.gz"
